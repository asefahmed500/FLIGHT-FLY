...
export function VisaServices({ onBookItem }: VisaServicesProps) {
  ...
  return (
    <section id="visa-services" className="bg-[#F8FAFC] py-24">
            ...
            <Reveal key={visa.id} variant="scale" delay={i * 80}>
              <Card className="group flex h-full flex-col justify-between overflow-hidden rounded-xl bg-white shadow-sm transition-all duration-300 hover:shadow-xl">
                <div className="relative h-44 overflow-hidden">
                  ...
                  <Badge className="absolute left-4 top-4 bg-[#0F172A] text-white font-semibold text-xs px-3 py-1 shadow-md">
...
<CardContent className="flex flex-1 flex-col justify-between p-5">
                  ...
                  <div className="pt-3 mt-3 border-t border-slate-100">
                    ...
                    <CardCta
                      ...
                      onAction={() => onBookItem({ title: visa.title, subtitle: visa.subtitle, price: visa.price, rating: visa.rating, type: "visa" })}
                    />
                  </div>
                </CardContent>
              </Card>
